...
namespace Enitity_trails
{
    ...
    public partial class rrsminiEntities : DbContext
    {
        public rrsminiEntities()
            : base("name=rrsminiEntities")
        {
        }
        ...
        public virtual ObjectResult<DisplayTrain_Result> DisplayTrain()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<DisplayTrain_Result>("DisplayTrain");
        }
    }
}
